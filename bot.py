...
async def cb_create_group_account_selected(event):
    ...
    await event.respond(
        ...
        buttons=[
            [
                Button.inline("👥 Grup Biasa (Kosong)", f"crg_type_basic_{phone}".encode('utf-8')),
                Button.inline("📇 Grup Biasa + Kontak", f"crg_type_basiccontacts_{phone}".encode('utf-8'))
            ],
            [
